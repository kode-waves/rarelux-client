...
const ProfileCard = (props) => {
  ...
  return (
    <div className={` ${explore ? "xl:w-60 md:w-56 lg:w-48  sm:w-48" : "xl:w-96 lg:w-72 md:w-80 sm:w-48 "} ${headList ? "h-96":"h-60"}  rounded-2xl relative overflow-hidden cursor-pointer`}>
      <div
      ...
      <div className="absolute inset-0 flex flex-col justify-end bg-gradient-to-t from-gray-800 via-transparent">
        <div className="flex xl:px-8 lg:px-2 md:px-2 sm:px-1 pt-10 items-center">
        ...
        <div className="flex justify-between xl:px-8 lg:px-2 md:px-2 sm:px-1 pb-4">
          <div>
